    ...
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-white flex flex-col transition-colors duration-300">
      ...
      <section className="flex-1 flex items-center justify-center px-6 py-24">
        <div className="max-w-2xl w-full flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 mb-8 text-[10px] uppercase tracking-widest font-bold text-violet-300 bg-violet-500/10 rounded-full border border-violet-400/20">
